...
export const getProduct= (keyword="",currentPage=1,category) => async (dispatch)=>{
  try {
    ...
    //  let link = `http://0.0.0.0:4000/api/v2/products?keyword=${keyword}&page=${currentPage}`;
     let link = `http://localhost:4000/api/v2/products`;
      
     if(category){
      // link = `http://0.0.0.0:4000/api/v2/products?keyword=${keyword}&page=${currentPage}&category=${category}`;
      link = `http://localhost:4000/api/v2/products`;
     }
